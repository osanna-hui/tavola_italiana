...
- Creating Customer
	We couldn't decide what was easiest to do in the beginning, whether it was easier to create a dummy customer from the start or only create a customer if the customer actually checks out. 
